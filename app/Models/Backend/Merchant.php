...
class Merchant extends Model
{
    ...
    */
    ...
    {
        return $this->belongsTo(Upload::class, 'agreement_file', 'id');
    }
    public function getAgreementProfAttribute()
    {
        if (!empty($this->agreement->original['original']) && file_exists(public_path($this->agreement->original['original']))) {
            return static_asset($this->agreement->original['original']);
        }
        return '';
    }
