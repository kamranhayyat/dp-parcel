                            ...
                            <div class="row">
                                ...
                                <div class="col-6">
                                    ...
                                    <div class="form-group d-none" id="time_group">
                                        ...
                                        <input id="time" type="time" name="time" data-parsley-trigger="change" placeholder="{{ __('placeholder.Enter_time') }}" autocomplete="off" class="form-control" value="{{ old('time') }}" required>
                                        @error('time')
                                        <small class="text-danger mt-2">{{ $message }}</small>
                                        @enderror
                                    </div>
