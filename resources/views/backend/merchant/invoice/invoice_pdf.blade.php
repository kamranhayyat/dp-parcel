...
<body>
                                    ...
                                    <tr>
                                        <td style="border:1px solid rgba(73, 73, 73, 0.226)!important;padding:0px">
                                            <table width="100%">
                                                ...
                                                <tr>
                                                    <td style="border-right:1px solid rgba(73, 73, 73, 0.226);padding:5px!important"><b>Discount Amount</b></td>
                                                    <td style="padding:5px!important;">
                                                        {{ settings()->currency }}{{@$invoice->discount_amount}}
                                                    </td>
                                                </tr>
                                                <tr>
                                                    ...
                                                    <td style="border-bottom:none!important;padding:5px!important;">
                                                        {{ $invoice->parcels->sum('current_payable') }}<br/> 
                                                         With Discount : {{ settings()->currency }}{{@$invoice->current_payable + $invoice->discount_amount}}  
                                                    </td>
                                                </tr>
                                            </table>
                                        </td>
    ...
    <table   cellspacing="0" width="100%">
        <tr style="background-color: #011e59;color:white">
            ...
            <th style="padding: 3px 10px;">Cash Collection <br/>({{ settings()->currency }})</th>
        ...
        @foreach ($invoice->parcels as $parcel)
            ...
            <tr style="background-color: #011e59;color:white">
                ...
                <th style="padding: 2px 10px;">
                    {{ number_format($invoice->parcels->sum('current_payable'),2) }}<br/>
                    With Discount : {{ settings()->currency }}{{@$invoice->current_payable + $invoice->discount_amount}}
                </th>
            </tr>
    </table>
