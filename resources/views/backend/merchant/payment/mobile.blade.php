    ...
    <div class="form-group">
        ...
        <div class="input-group mb-3">
            ...
            <div class="form-floating"> 
                <input id="mobile_no" type="number" name="mobile_no" data-parsley-trigger="change" placeholder="{{ __('placeholder.Enter_mobile_number') }}" autocomplete="off" class="form-control input-end-redius" value="{{old('mobile_no')}}" require>
            </div>
        </div>
        @error('mobile_no')
            <small class="text-danger mt-2">{{ $message }}</small>
