    ...
    <div class="card">
        <div class="row">
                        ...
                        <div class="form-group">
                            <div class="input-group mb-3">
                                ...
                                <div class="form-floating"> 
                                    <input id="mobile" type="number" class="form-control form-control-lg input-end-redius @error('mobile') is-invalid @enderror" name="mobile" value="{{ old('mobile',$request
            ...
            <div class="col-lg-7 footer-img">
                <img class="img-responsive margin-t-20 py-5" src="{{ static_asset('images/default/dp-process.png') }}" width="100%"/>
            </div>
        </div>
    </div>
</form>
