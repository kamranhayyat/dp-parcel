                ...
                <div class="card-body">
                    ...
                    <form action="{{route('merchant.store')}}"  method="POST" enctype="multipart/form-data" id="basicform">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-group mb-3">
                                        ...
                                        <div class="form-floating"> 
                                            <input id="mobile" type="number" name="mobile" data-parsley-trigger="change" placeholder="{{ __('placeholder.Enter_mobile') }}" autocomplete="off" class="form-control input-end-redius" value="{{old('mobile')}}">
                                        </div>
                                    </div> 
                                    @error('mobile')
                                        <small class="text-danger mt-2">{{ $message }}</small>
                        ...
                        <div class="row">
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group  "> 
                                                ...
                                                <div class="input-group mb-3">
                                                    <span class="input-group-text">{{ mobile_prefix() }}</span>
                                                    <div class="form-floating"> 
                                                        <input type="number" id="reference_phone" placeholder="{{ __('levels.reference_phone') }}" name="reference_phone" class="form-control input-end-redius" value="{{ old('reference_phone') }}">
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                            ...
                            <div class="col-md-6">
                                <div class="form-group ">
                                    ...
                                    <input type="number" id="payment_period" placeholder="{{ __('levels.invoice_setteld') }}" name="payment_period" class="form-control" value="{{ old('payment_period',30) }}">
                                </div>
                            </div>
                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="form-group">
                                    <label><input type="checkbox" value="1" id="isAgreement" name="is_agreement"  @if ($errors->has('is_agreement') || old('is_agreement'))
                                       checked @endif/> Agreement ?</label>
                                </div>  
                            </div> 
                        </div>
                        <div class="row agreement" @if(old('target') || old('discount') || old('agreement_file')) @else style="display: none" @endif >
                            <div class="col-md-4">
                                <div class="form-group">
                                    <label  >Target</label>
                                    <input type="text" name="target" autocomplete="off" class="form-control" value="{{ old('target')}}" placeholder="Enter target">
                                </div> 
                            </div> 
                            <div class="col-md-4">
                                <div class="form-group">
                                    <label >Discount (%)</label>
                                    <input type="text" name="discount" autocomplete="off" class="form-control" value="{{ old('discount')}}" placeholder="Enter discount">
                                </div> 
                            </div>
