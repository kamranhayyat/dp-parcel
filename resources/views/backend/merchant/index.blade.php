                        ...
                        <table id="table" class="table   " style="width:100%">
                            <thead>
                                <tr>
                                    ...
                                    <th>{{ __('levels.invoice_setteld') }}<br/><small>( Invoice will Generate After days)</small></th>
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>{{@$merchant->payment_period}}</td>
                                    <td>{{@$merchant->merchant_unique_id}}</td>
                                    <td>{{ mobile_prefix().@$merchant->user->mobile}}</td>
                                        ...
                                        <td>
                                            <div class="row">
                                                ...
                                                <div class="dropdown-menu">
                                                    ...
                                                    @if( hasPermission('merchant_permissions') == true  )
                                                        <a href="{{route('merchant.permissions',$merchant->id)}}" class="dropdown-item"><i class="fa fa-key" aria-hidden="true"></i> {{ __('permissions.permissions') }}</a>
                                                    @endif
