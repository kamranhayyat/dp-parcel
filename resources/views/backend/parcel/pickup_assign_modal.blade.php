            ...
            <form action="{{ route('parcel.pickup.man-assigned',['page'=>$request->page,'filter'=>$request->filter? $request->filter:'']) }}" method="post">
                ...
                <div class="modal-body">
                    <div class="form-group  ">
                        <label for="delivery_man_search_assigns">{{ __('parcel.pickup_man')}}</label> <span class="text-danger">*</span>
                        <div class="form-control-wrap deliveryman-search">
                            <select id="delivery_man_search_assigns" class="form-control delivery_man_search" name="delivery_man_id" data-url="{{ route('parcel.deliveryman.search') }}" >
