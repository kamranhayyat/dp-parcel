    ...
    <table style="width:100%;height:50px;max-width:650px;margin: auto;background-color: white;">
        <tr>
            <td style="padding:30px;line-height: 1.5;" colspan="2">
                <p>Hi <b style="font-style: italic;">{{ @$data['user']->name }}</b>,</p>
                <p>Thank you for your interest in becoming an deliveryman with {{ @settings()->name }}.</p>
                ...
                <div style="display: flex;">
                    <div style="width: 20%;display: inline-block;"><b>Password</b></div>
                    <div>: {{ @$data['password'] }}</div>
                </div>
                <p style="color: #011e59;font-weight: bold;">Your Business Information :</p>
                <div style="display: flex;">
                    <div style="width: 20%;display: inline-block;"><b>Name</b></div>
                ...
                <p>Please login your delivery mobile apps. </p>
