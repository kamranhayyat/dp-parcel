                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6"> 
                                <div class="form-group"> 
                                    ...
                                    <div class="input-group mb-3">
                                        ...
                                        <div class="form-floating"> 
                                            <input id="mobile" type="text"   name="mobile" data-parsley-trigger="change" placeholder="{{ __('placeholder.Enter_phone') }}" autocomplete="off" class="form-control input-end-redius @error('mobile') is-invalid @enderror" value="{{old('mobile',\Str::replace( mobile_prefix(),'',$deliveryman->user->mobile))}}">
                                        </div> 
                                    </div>
                                    @error('mobile')
                                        <small class="text-danger mt-2">{{ $message }}</small>
                                ...
                                <div>
                                    ...
                                    @foreach ($deliveryman->document_files as $file)
                                        <div>
                                            File {{ $loop->index+1 }}: <a href="{{ static_asset($file->original) }}" download="" class="text-primary">Download</a>
                                        </div>
                                    @endforeach
                                </div> 
                            </div>
