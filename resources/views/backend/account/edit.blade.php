                                ...
                                <div class="form-group" id="mobile">
                                    ...
                                    <div class="input-group mb-3">
                                        ...
                                        <div class="form-floating"> 
                                            <input type="number" name="mobile" data-parsley-trigger="change" placeholder="{{ __('placeholder.Enter_mobile') }}" autocomplete="off" class="form-control input-end-redius" value="{{$account->mobile}}" require>
                                        </div>
                                    </div>
                                    @error('mobile')
                                        <small class="text-danger mt-2">{{ $message }}</small>
