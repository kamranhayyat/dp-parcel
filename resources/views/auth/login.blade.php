            ...
            <div class="card">
                <div class="row">
                    <div class="col-lg-5">
                        <div class="card auth-boxs">
                            <div class="card-header text-center">
                                ...
                                <span class="splash-description">Please enter your user information. {{ strtotime(date('m')) }} - {{ date('h') }}</span>
                                </div>
                            <div class="card-body">
                    ...
                    <div class="col-lg-7 footer-img">
                        <img class="img-responsive margin-t-20 " src="{{ static_asset('images/default/dp-process.png') }}" width="100%" />
                    </div>
                </div>
            </div>
        </div>
