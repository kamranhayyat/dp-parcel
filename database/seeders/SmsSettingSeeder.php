...
class SmsSettingSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        //eSMS
        SmsSetting::create(['key' => 'e_sms_token', 'value' => '']);
        SmsSetting::create(['key' => 'e_sms_username', 'value' => '']);
        SmsSetting::create(['key' => 'e_sms_password', 'value' => '']);
        SmsSetting::create(['key' => 'e_sms_status', 'value' => Status::INACTIVE]);
    }
}
