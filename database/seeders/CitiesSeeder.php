...
class CitiesSeeder extends Seeder
{
    ...
    public function run(): void
    {
        $cities = [
            ...
            ['name' => 'Nuwara Eliya', 'district_id' => 8],
            ['name' => 'Hatton', 'district_id' => 8],
            ['name' => 'Talawakelle', 'district_id' => 8],
            ['name' => 'Lindula', 'district_id' => 8],
            ['name' => 'Ginigathena', 'district_id' => 8],
            ['name' => 'Ragala', 'district_id' => 8],
            ['name' => 'Maskeliya', 'district_id' => 8],
            ['name' => 'Kotagala', 'district_id' => 8],
            ['name' => 'Nanu Oya', 'district_id' => 8],
            ['name' => 'Pundaluoya', 'district_id' => 8],
            ['name' => 'Walapane', 'district_id' => 8],
            ['name' => 'Agarapathana', 'district_id' => 8],
            ['name' => 'Bogawantalawa', 'district_id' => 8],
            ['name' => 'Norwood', 'district_id' => 8],
            ['name' => 'Kandapola', 'district_id' => 8],
            ['name' => 'Rikillagaskada', 'district_id' => 8],
            ['name' => 'Ambewela', 'district_id' => 8],
            ['name' => 'Dayagama', 'district_id' => 8],
            ['name' => 'Labookellie', 'district_id' => 8],
            ['name' => 'Rozella', 'district_id' => 8],
            ['name' => 'Kalapitiya', 'district_id' => 8],
            ['name' => 'Holbrook', 'district_id' => 8],
            ...
            ['name' => 'Kalkudah', 'district_id' => 17],
            ['name' => 'Kaluwanchikudy', 'district_id' => 17],
            ['name' => 'Chenkalady', 'district_id' => 17],
            ['name' => 'Oddamavadi', 'district_id' => 17],
            ['name' => 'Paddiruppu', 'district_id' => 17],
            ['name' => 'Navatkadu', 'district_id' => 17],

            ['name' => 'Ampara', 'district_id' => 18],
            ['name' => 'Kalmunai', 'district_id' => 18],
            ['name' => 'Sainthamaruthu', 'district_id' => 18],
            ['name' => 'Akkaraipattu', 'district_id' => 18],
            ['name' => 'Sammanthurai', 'district_id' => 18],
            ['name' => 'Uhana', 'district_id' => 18],
            ['name' => 'Damana', 'district_id' => 18],
            ['name' => 'Dehiattakandiya', 'district_id' => 18],
            ['name' => 'Lahugala', 'district_id' => 18],
            ['name' => 'Pottuvil', 'district_id' => 18],
            ['name' => 'Addalaichenai', 'district_id' => 18],
            ['name' => 'Thirukkovil', 'district_id' => 18],

            ['name' => 'Trincomalee', 'district_id' => 19],
            ['name' => 'Kinniya', 'district_id' => 19],
            ['name' => 'Mutur', 'district_id' => 19],
            ['name' => 'Kantale', 'district_id' => 19],
            ['name' => 'Nilaveli', 'district_id' => 19],
            ['name' => 'Thampalakamam', 'district_id' => 19],
            ['name' => 'China Bay', 'district_id' => 19],
            ['name' => 'Thiriyai', 'district_id' => 19],

            ['name' => 'Kurunegala', 'district_id' => 20],
            ['name' => 'Kuliyapitiya', 'district_id' => 20],
            ['name' => 'Narammala', 'district_id' => 20],
            ['name' => 'Melsiripura', 'district_id' => 20],
            ['name' => 'Wariyapola', 'district_id' => 20],
            ['name' => 'Pannala', 'district_id' => 20],
            ['name' => 'Polgahawela', 'district_id' => 20],
            ['name' => 'Alawwa', 'district_id' => 20],
            ['name' => 'Mawathagama', 'district_id' => 20],
            ['name' => 'Rideegama', 'district_id' => 20],
            ['name' => 'Hettipola', 'district_id' => 20],
            ['name' => 'Bingiriya', 'district_id' => 20],
            ['name' => 'Kobeigane', 'district_id' => 20],
            ['name' => 'Rasnayakapura', 'district_id' => 20],
            ['name' => 'Ganewatta', 'district_id' => 20],
            ['name' => 'Weerambugedara', 'district_id' => 20],

            ['name' => 'Puttalam', 'district_id' => 21],
            ['name' => 'Chilaw', 'district_id' => 21],
            ['name' => 'Wennappuwa', 'district_id' => 21],
            ['name' => 'Anamaduwa', 'district_id' => 21],
            ['name' => 'Kalpitiya', 'district_id' => 21],
            ['name' => 'Mundel', 'district_id' => 21],
            ['name' => 'Madampe', 'district_id' => 21],
            ['name' => 'Marawila', 'district_id' => 21],
            ['name' => 'Nattandiya', 'district_id' => 21],
            ['name' => 'Arachchikattuwa', 'district_id' => 21],
            ['name' => 'Pallama', 'district_id' => 21],
            ['name' => 'Dankotuwa', 'district_id' => 21],
            ['name' => 'Kottukachchiya', 'district_id' => 21],

            ['name' => 'Anuradhapura', 'district_id' => 22],
            ['name' => 'Mihintale', 'district_id' => 22],
            ['name' => 'Kekirawa', 'district_id' => 22],
            ['name' => 'Thalawa', 'district_id' => 22],
            ['name' => 'Medawachchiya', 'district_id' => 22],
            ['name' => 'Rambewa', 'district_id' => 22],
            ['name' => 'Eppawala', 'district_id' => 22],
            ['name' => 'Galenbindunuwewa', 'district_id' => 22],
            ['name' => 'Habarana', 'district_id' => 22],
            ['name' => 'Kahatagasdigiliya', 'district_id' => 22],
            ['name' => 'Nochchiyagama', 'district_id' => 22],
            ['name' => 'Thambuttegama', 'district_id' => 22],
            ['name' => 'Horowpathana', 'district_id' => 22],

            ['name' => 'Polonnaruwa', 'district_id' => 23],
            ['name' => 'Hingurakgoda', 'district_id' => 23],
            ['name' => 'Medirigiriya', 'district_id' => 23],
            ['name' => 'Thamankaduwa', 'district_id' => 23],
            ['name' => 'Dimbulagala', 'district_id' => 23],
            ['name' => 'Lankapura', 'district_id' => 23],
            ['name' => 'Elahera', 'district_id' => 23],
            ['name' => 'Manampitiya', 'district_id' => 23],
            ['name' => 'Welikanda', 'district_id' => 23],
            ['name' => 'Giritale', 'district_id' => 23],

            ['name' => 'Badulla', 'district_id' => 24],
            ['name' => 'Bandarawela', 'district_id' => 24],
            ['name' => 'Ella', 'district_id' => 24],
            ['name' => 'Haputale', 'district_id' => 24],
            ['name' => 'Mahiyanganaya', 'district_id' => 24],
            ['name' => 'Hali Ela', 'district_id' => 24],
            ['name' => 'Welimada', 'district_id' => 24],
            ['name' => 'Passara', 'district_id' => 24],
            ['name' => 'Uva-Paranagama', 'district_id' => 24],
            ['name' => 'Lunugala', 'district_id' => 24],
            ['name' => 'Meegahakivula', 'district_id' => 24],

            ['name' => 'Moneragala', 'district_id' => 25],
            ['name' => 'Wellawaya', 'district_id' => 25],
            ['name' => 'Bibile', 'district_id' => 25],
            ['name' => 'Buttala', 'district_id' => 25],
            ['name' => 'Siyambalanduwa', 'district_id' => 25],
            ['name' => 'Medagama', 'district_id' => 25],
            ['name' => 'Madulla', 'district_id' => 25],
            ['name' => 'Thanamalwila', 'district_id' => 25],
            ['name' => 'Kataragama', 'district_id' => 25],

            ['name' => 'Ratnapura', 'district_id' => 26],
            ['name' => 'Balangoda', 'district_id' => 26],
            ['name' => 'Eheliyagoda', 'district_id' => 26],
            ['name' => 'Pelmadulla', 'district_id' => 26],
            ['name' => 'Kuruwita', 'district_id' => 26],
            ['name' => 'Kahawatta', 'district_id' => 26],
            ['name' => 'Wewelwatta', 'district_id' => 26],
            ['name' => 'Kalawana', 'district_id' => 26],
            ['name' => 'Nivithigala', 'district_id' => 26],
            ['name' => 'Ayagama', 'district_id' => 26],
            ['name' => 'Opanayaka', 'district_id' => 26],
            ['name' => 'Elapatha', 'district_id' => 26],
            ['name' => 'Kiriella', 'district_id' => 26],
            ['name' => 'Imbulpe', 'district_id' => 26],

            ['name' => 'Kegalle', 'district_id' => 27],
            ['name' => 'Mawanella', 'district_id' => 27],
            ['name' => 'Warakapola', 'district_id' => 27],
            ['name' => 'Rambukkana', 'district_id' => 27],
            ['name' => 'Galigamuwa', 'district_id' => 27],
            ['name' => 'Aranayake', 'district_id' => 27],
            ['name' => 'Bulathkohupitiya', 'district_id' => 27],
            ['name' => 'Dehiowita', 'district_id' => 27],
            ['name' => 'Deraniyagala', 'district_id' => 27],
            ['name' => 'Ruwanwella', 'district_id' => 27],
            ['name' => 'Yatiyanthota', 'district_id' => 27],
        ];
