...
return new class extends Migration
{
    ...
    public function up()
    {
        Schema::create('merchants', function (Blueprint $table) {
            ...
            $table->string('payment_period')->default(30)->comment('30 = 30days , after every 30days will auto payment invoice generate');
            ...
            $table->unsignedTinyInteger('wallet_use_activation')->default(Status::INACTIVE)->nullable();
             ...
             $table->decimal('target',2,16)->nullable();
             $table->decimal('discount',2,16)->nullable();
             $table->decimal('agreement_file',2,16)->nullable();
             $table->timestamps();
        });
    }
