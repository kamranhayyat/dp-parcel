    ...
    Route::group(['middleware' => 'auth'], function () {
        ...
        Route::group(['middleware' => 'XSS'], function () {
            ...
            Route::group(['prefix' => 'admin'], function () {
                ...
                Route::get('merchant/permissions/{id}',      [MerchantController::class, 'permissions'])->name('merchant.permissions')->middleware('hasPermission:merchant_permissions');
                Route::put('merchant/permissions/update',    [MerchantController::class, 'permissionsUpdate'])->name('merchant.permissions.update')->middleware('hasPermission:merchant_permissions');
                ...
                Route::post('parcel/collect/to/pickup',             [ParcelController::class, 'collectToPickup'])->name('parcel.collect_to_pickup')->middleware('hasPermission:parcel_status_update');
                ...
                Route::post('parcel/branch/cancel',                 [ParcelController::class, 'parcelBranchCancel'])->name('parcel.branch_cancel')->middleware('hasPermission:parcel_status_update');
                ...
                Route::get('deliveryman/view/{id}',   [DeliveryManController::class, 'view'])->name('deliveryman.view')->middleware('hasPermission:delivery_man_read');
